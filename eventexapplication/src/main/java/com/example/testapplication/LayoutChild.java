...
public class LayoutChild extends FrameLayout implements UIEventListener {
    private EditText editText;

    public LayoutChild(Context context) {
        super(context);
        init();
    }

    public LayoutChild(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LayoutChild(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        LayoutGrandchild child = new LayoutGrandchild(getContext());
        ViewGroup viewGroup = findViewById(R.id.grand_child_cont);
        viewGroup.addView(child);
        TextView textView = findViewById(R.id.child_title_text);
        textView.setText(R.string.child_layout_title);
        editText = findViewById(R.id.child_edit_text);
    }
